...
#define BUILD_VARIANT_LABEL "jinghu_clean"
#ifndef BUILD_FINGERPRINT
#define BUILD_FINGERPRINT "Xiaomi/jinghu/jinghu:16/BP2A.250605.031.A3/OS3.0.301.0.WOXCNXM:user/release-keys"
#endif

// === Memory Layout (verified from config: VA_BITS=39) ===
...
// === Function/Data Offsets (verified from vmlinux symbol table) ===
#define ASHMEM_MISC_FOPS_OFF          0x0223b5e8ULL
#define ASHMEM_FOPS_OFF               0x012c9df0ULL
#define ASHMEM_IOCTL_OFF              0x00c7a62cULL
#define ASHMEM_COMPAT_IOCTL_OFF       0x00c7ace8ULL
#define ASHMEM_MMAP_OFF               0x00c7ad3cULL
#define ASHMEM_OPEN_OFF               0x00c7af5cULL
#define ASHMEM_RELEASE_OFF            0x00c7afe4ULL
#define ASHMEM_SHOW_FDINFO_OFF        0x00c7b070ULL
#define CONFIGFS_READ_ITER_OFF        0x00488978ULL
#define CONFIGFS_BIN_WRITE_ITER_OFF   0x00488ea4ULL
#define COPY_SPLICE_READ_OFF          0x0040d4acULL
#define NOOP_LLSEEK_OFF               0x003c0380ULL
#define INIT_TASK_OFF                 0x020de280ULL
#define INIT_CRED_OFF                 0x020f0548ULL
#define ROOT_TASK_GROUP_OFF           0x022d4580ULL
#define SELINUX_BLOB_SIZES_OFF        0x0164fb48ULL
#define SELINUX_ENFORCING_OFF         0x02315f68ULL
#define SECURITY_HOOK_HEADS_OFF       0x0164f410ULL
#define KMALLOC_CACHES_OFF            0x0164ef50ULL
#define ANON_PIPE_BUF_OPS_OFF         0x0114a288ULL

// === SLIDE Offsets (verified from vmlinux) ===
#define SLIDE_NFULNL_LOGGER_OFF         0x020d2270ULL
#define SLIDE_LOGGERS_0_1_OFF           0x020d21b8ULL
#define SLIDE_RANDOM_BOOT_ID_DATA_OFF   0x02336f58ULL
...
// === All struct offsets: EXACT COPY of frankel-CP1A.260305.018 ===
